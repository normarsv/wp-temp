...
<div class="woocommerce-account-fields clearfix">
	<?php if ( ! $checkout->is_registration_required() ) : ?>
		...
		<p class="form-row form-row-wide create-account">
			...
			<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox" for="createaccount"><span><?php esc_html_e( 'Create an account?', 'woocommerce' ); ?></span></label>
		</p>
