...
<form action="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" method="post" class="woocommerce-form woocommerce-form-track-order track_order">
	<div class="wtbx-section-title">
		<h2><?php esc_html_e('Order Tracking', 'scape') ?></h2>
	</div>
    ...
    <p class="form-row"><button type="submit" class="button wtbx-button wtbx-button-primary button-sm" name="track" value="<?php esc_attr_e( 'Track', 'woocommerce' ); ?>"><?php esc_html_e( 'Track', 'woocommerce' ); ?></button></p>
