...
if(!class_exists('WTBX_Aq_Resize')) {
	class Aq_Exception extends Exception {}

	class WTBX_Aq_Resize
	{
		/**
		...
		/**
		 * For your custom default usage you may want to initialize an WTBX_Aq_Resize object by yourself and then have own defaults
		 */
...
//				if ( true === $upscale ) remove_filter( 'image_resize_dimensions', array( $this, 'aq_upscale' ) );
				...
				error_log('WTBX_Aq_Resize.process() error: ' . $ex->getMessage());
...
if(!function_exists('wtbx_aq_resize')) {

	/**
	 * This is just a tiny wrapper function for the class above so that there is no
	 * need to change any code in your own WP themes. Usage is still the same :)
	 */
	function wtbx_aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
		$aq_resize = WTBX_Aq_Resize::getInstance();
