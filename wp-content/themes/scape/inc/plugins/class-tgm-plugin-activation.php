 ...
 * @version   2.6.1 for parent theme Scape for publication on ThemeForest
...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		protected function add_admin_menu( array $args ) {
			$this->page_hook = add_submenu_page( 'scape-dashboard', $args['page_title'], $args['menu_title'], $args['capability'], $args['menu_slug'], $args['function'] );
		}
