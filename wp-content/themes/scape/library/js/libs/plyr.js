			...
			player.embed = new window.YT.Player(id, {
				...
				events: {
					...
					onReady: function onReady(event) {
						...
						// Playback speed
						if (typeof player.media.playbackRate === "undefined") {
						...
						// Quality
						if (typeof player.media.quality === "undefined") {
							Object.defineProperty(player.media, 'quality', {
								get: function get() {
						...
						if (typeof player.media.volume === "undefined") {
						...
						if (typeof player.media.muted === "undefined") {
						...
						// Source
						if (typeof player.media.currentSrc === "undefined") {
						...
						// Ended
						if (typeof player.media.ended === "undefined") {
