...
<div id="header-wrapper" class="header-desktop header-wrapper header-style-<?php echo esc_attr($header_style . ' ' . $layout . $borders . $header_skin_class . $header_sticky . $sticky_skin_class . $shadow_class); ?>">
