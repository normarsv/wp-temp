<div class="wtbx_header_part header_button wtbx_header_login_alt">
	<?php if (!is_user_logged_in()): ?>
		<a href="<?php echo esc_url( wp_login_url( get_permalink() ) ); ?>" class="wtbx_login_modal_trigger wtbx_text_color wtbx_h_text_color" data-reveal-id="wtbx_login_modal">
	...
	<?php else: ?>
		<a href="<?php echo esc_url( wp_logout_url( get_permalink() ) ); ?>" class="wtbx_header_link wtbx_text_color wtbx_h_text_color">
