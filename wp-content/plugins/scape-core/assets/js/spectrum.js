...
(function (window, $, undefined) {
	...
	$.fn.wtbx_spectrum = function (opts, extra) {
		...
		return this.wtbx_spectrum("destroy").each(function () {
	...
	$.fn.wtbx_spectrum.load = true;
	$.fn.wtbx_spectrum.loadOpts = {};
	$.fn.wtbx_spectrum.draggable = draggable;
	$.fn.wtbx_spectrum.defaults = defaultOpts;

	$.wtbx_spectrum = { };
	$.wtbx_spectrum.localization = { };
	$.wtbx_spectrum.palettes = { };

	$.fn.wtbx_spectrum.processNativeColorInputs = function () {
		if (!inputTypeColorSupport) {
			$("input[type=color]").wtbx_spectrum({
	...
	$(function () {
		if ($.fn.wtbx_spectrum.load) {
			$.fn.wtbx_spectrum.processNativeColorInputs();
		}
	});
