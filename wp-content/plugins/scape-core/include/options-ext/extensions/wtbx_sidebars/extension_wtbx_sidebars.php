...
// Don't duplicate me!
if( !class_exists( 'ReduxFramework_extension_wtbx_sidebars' ) ) {
     ...
     * @since       3.1.6
     */
    class ReduxFramework_extension_wtbx_sidebars extends ReduxFramework {
