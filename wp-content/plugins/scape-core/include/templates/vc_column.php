<?php
$column_height = $output = $font_color = $bg_style = $bg_image_el = $textalign_small = $lazy =
...
$column_scroll_speed !== '' ? $shortcode_class[] = 'wtbx_column_scroll_smooth' : null;
...
if ( $custom_bg_image !== '' ) {
	$bg_styles = array();
	$bg_image_el = wtbx_image_smart_bg( $custom_bg_image, 'medium', 'full', false, wtbx_get_alt_text($custom_bg_image), 'wtbx_column_bg_image', true, $lazy );
...
$js_styles .= $font_color !== '' || $typography_string !== '' || $min_height !== '' ? $unique_class_css.' .wtbx_vc_column_container .wtbx_column_wrapper .wtbx_column_content {' . wtbx_vc_color_styles_text($font_color) . $typography_string . $min_height . '}' : '';
$js_styles .= $min_height !== '' && wtbx_vc_is_page_editable() ? '.vc_editor.compose-mode .wtbx_vc_column.vc_empty-element'.$unique_class_css.' .wtbx_vc_column_container .wtbx_column_wrapper .wtbx_column_content {' . $min_height . '}' : '';
$bg_style !== '' ? $js_styles .= $unique_class_css.' .wtbx-bg-image .wtbx-bg-image-inner .wtbx_column_bg_image {' . $bg_style . '}' : null;
$js_styles .= $bg_color_string !== '' ? $unique_class_css.' .wtbx_column_bg {' . $bg_color_string . '}' : '';

$margin_selector    = $unique_class_css . ' .' . $element_class . '_inner';
$border_selector    = $unique_class_css . ' .wtbx_column_bg';
$padding_selector   = $unique_class_css . ' .wtbx_column_content';
$offset_selector    = $unique_class_css . ' .wtbx_column_content';
...
$js_styles .= $color_border !== '' ? $unique_class_css.' .wtbx_column_bg {' . $color_border .'}' : '';
...
// shortcode
	$output .= '<div class="wtbx_vc_el_container '.esc_attr($element_class).'_container">';
		$output .= $inner_open;
			if ( !empty($bg_image_el) || !empty($bg_color_string) || !empty($border_color) ) {
				$output .= '<div class="wtbx_column_bg">';

				if ( !empty($bg_image_el) ) {
					$output .= '<div class="wtbx_column_bg_inner wtbx-element-reveal wtbx-reveal-cont">';
					$output .= $bg_image_el;
					$output .= '</div>';
				}
			...
			$output .= '<div class="wtbx_column_wrapper clearfix">';
				$output .= '<div class="wtbx_column_content">';
