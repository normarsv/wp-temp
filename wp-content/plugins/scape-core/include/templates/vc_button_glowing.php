...
$border_radius = $border_radius_h = $action = $bg_color = $bg_color_h = $text_color = $text_color_h = $title = '';
...
// element style
$shortcode_class[] = 'wtbx_style_glowing';
...
$bg_color_h             = !empty(wtbx_vc_color_styles_bg($bg_color_h)) ? $bg_color_h : $bg_color;
$color_bg_h             = wtbx_vc_color_styles_bg($bg_color_h);
$color_shadow           = wtbx_vc_color_styles_shadow($bg_color_h, '0 5px 30px -2px', '0.7');
...
$button .= '<a '.$a_href.$a_title.$a_target.$a_rel.' class="wtbx-button wtbx-button-glowing'.$lightbox_class.$this->getExtraClass( $el_class ).'"'.$lightbox.$custom_code.'>' . $inner . '</a>';
...
$margin !== '' ? $js_styles .= $unique_class_css.'.wtbx_style_glowing .wtbx_vc_button_container .wtbx_vc_button_inner {' . $margin . '}' : null;
$typography_string !== '' || $padding !== '' ? $js_styles .= $unique_class_css.'.wtbx_style_glowing .wtbx_vc_button_container .wtbx_vc_button_inner .wtbx-button {' . $typography_string . $padding . '}' : null;
$color_text !== '' ? $js_styles .= $unique_class_css.'.wtbx_style_glowing .wtbx-button-glowing {' . $color_text .  '}' : null;
$color_text_h !== '' ? $js_styles .= $unique_class_css.'.wtbx_style_glowing .wtbx-button-glowing:hover {' . $color_text_h . '}' : null;
$color_bg !== '' ? $js_styles .= $unique_class_css.'.wtbx_style_glowing .wtbx-button-glowing:before {' . $color_bg . '}' : null;
$color_bg_h !== '' ? $js_styles .= $unique_class_css.'.wtbx_style_glowing .wtbx-button-glowing:after {' . $color_bg_h . '}' : null;
$border_radius !== '' ? $js_styles .= $unique_class_css.'.wtbx_style_glowing .wtbx-button-glowing,'.$unique_class_css.' .wtbx-button-glowing:before, '.$unique_class_css.' .wtbx-button-glowing:after {' . $border_radius . '}' : null;
$border_radius_h !== '' ? $js_styles .= $unique_class_css.'.wtbx_style_glowing .wtbx-button-glowing:hover,'.$unique_class_css.' .wtbx-button-glowing:hover:before, '.$unique_class_css.' .wtbx-button-glowing:hover:after {' . $border_radius_h . '}' : null;
$color_shadow !== '' ? $js_styles .= $unique_class_css.'.wtbx_style_glowing .wtbx-button-glowing:hover:before {' . $color_shadow . '}' : null;
