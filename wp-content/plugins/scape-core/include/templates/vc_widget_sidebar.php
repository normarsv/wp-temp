 ...
 */
$title = $el_class = $el_id = $sidebar_id = $skin = '';
...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_widgetised_column wpb_content_element' . $el_class . $skin, $this->settings['base'], $atts );
