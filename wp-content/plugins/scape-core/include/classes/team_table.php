...
/**
 */
class WPBakeryShortCode_VC_Team_Table extends WPBakeryShortCode {
...
//		}
	...
	public function contentAdmin( $atts, $content = null ) {
		...
		preg_match_all( '/vc_team_table_member title="([^\"]+)"(\stab_id\=\"([^\"]+)\"){0,1}/i', $content, $matches, PREG_OFFSET_CAPTURE );
		/*
$tab_titles = array();
...
*/
	...
	public function getTabTemplate() {
		return '<div class="wpb_template">' . do_shortcode( '[vc_team_table_member title="Team member" tab_id=""][/vc_team_table_member]' ) . '</div>';
	}
...
class WPBakeryShortCode_VC_Team_Table_Member extends WPBakeryShortCode_VC_Column {
