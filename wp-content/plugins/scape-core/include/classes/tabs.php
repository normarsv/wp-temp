...
class WPBakeryShortCode_VC_Custom_Tabs extends WPBakeryShortCode {
	...
	public function contentAdmin( $atts, $content = null ) {
		...
		preg_match_all( '/vc_custom_tab title="([^\"]+)"(\stab_id\=\"([^\"]+)\"){0,1}/i', $content, $matches, PREG_OFFSET_CAPTURE );
	...
	public function getTabTemplate() {
		return '<div class="wpb_template">' . do_shortcode( '[vc_custom_tab title="Tab" tab_id=""][/vc_custom_tab]' ) . '</div>';
	}
...
//define( 'SCAPE_TAB_TITLE', __( 'Tab', 'js_composer' ) );
require_once vc_path_dir( 'SHORTCODES_DIR', 'vc-column.php' );


class WPBakeryShortCode_VC_Custom_Tab extends WPBakeryShortCode_VC_Column {
